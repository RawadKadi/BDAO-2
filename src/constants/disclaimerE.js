const disclaimersEng = [
...
},
    {
        ...
        content : () => {
            return (
                ...
                <br /><br />
                While deploying the breakthrough potential of cryptocurrencies, Bricklayer DAO was launched to contribute to the development of the real estate sector. For decades the working wage has not inflated at the same pace as real estate, thus contributing to multiple generations starting to embrace the blockchain industry because of the low-entry barrier and lucrative opportunities it presents. Nevertheless, one of the main points of apprehension to this nascent adoption is the frustration of market volatility. Bricklayer DAO has been built to limit this risk by avoiding the sudden steep declines and the now-famous TerraLuna and ‘Rug-Pull’ situations.
                <br /> <br />
                Our selected blockchain native token would be exchanged for the BRICKS governance token and stored in the DAO Treasury. BRICKS token holders are incentivized to actively participate with voting rights, allowing members to play their part in a hybrid acquisition journey of both commercial real estate and cryptocurrency markets.
                <br /> <br />
                We aim to provide the digital functionality that is both the most dynamic and the practically applicable for capital raising, asset management, automated compliance, investor management, and custodial systems.
                <br /><br />
                <span className="italic">Building a Democratized Ecosystem</span>
                <br /><br />
                Bricklayer DAO sets a new benchmark for both blockchain and real estate enthusiasts to create a self-empowered democratized ecosystem, eliminating the corporate boardroom and bridging the gap between the interests of owner and investor, maximizing transparency, value, and real-time strategic decision making.
                <br /> <br />
    ...
    },
    {
        ...
        content : () => {
            return (
                ...
                <br /> <br />
                <span className="italic">Exploring the Expanding Dependency on e-Commerce</span>
                <br /><br />
                Since the dependency on e-Commerce has been exacerbated by the present pandemic, the industrial sector is often regarded as the most promising area for real estate investment. Last-mile logistics and warehousing are now recognized more than ever as required components of a fully effective Metro Service Areas (MSA) infrastructure network.
                <br />
                As a result of the growing demand for e-commerce, the industrial warehousing sector of the real estate industry has shown to be the most robust. E-commerce saw a year-over-year growth rate that skyrocketed to 44.5 % in 2021 (Jdsupra, 2022). According to the findings of CBRE Research, an increase of one billion dollars in additional e-commerce sales results in need for one quarter of a million square feet of warehouse space. As a result, it is anticipated that the net absorption in North America will reach close to 250 million square feet in 2021, which will be higher than the five-year annual average of 211 million square feet that was recorded before (CBRE, 2021).
                <br /> <br />
                ...
                <br /> <br />
                <span className="italic">Converging DAO’s Layer One with Current Market Gaps</span>
                <br /> <br />
                Statistics indicate a supply shortage in available inventory across the United States, coupled with the multiple development barriers for new warehouse construction, particularly in the State of California, positions the DAO’s Layer 1 acquisitions on a positive trajectory for both rental growth and capital appreciation.
                <br /> <br />
                Knowledge of these market drivers and long-term leases with the sector’s most in-demand credit tenant, in the safest asset class in commercial property, provide the most stable, income-producing platform to support and protect the token holder’s investment in the DAO.
                <br /> <br />
                These ‘Genesis’ Layer 1 acquisitions simply represent the underlying solidity of the DAO treasury. As the portfolio and the member community expand, the DAO may vote to diversify into international territories and alternative real estate asset classes (Layer 2), even partnering with DAO members’ hometowns and cities to create government-backed revitalization projects of historically significant buildings or social housing projects.
                </p>
                </>
            )
        }
    },
    {
        ...
        content : () => {
            return (
                ...
                <br /> <br />
                However, the drawbacks of using these vehicles for investment include that they provide dividends that are treated as regular income for tax purposes, that they have high administrative costs, and that they charge significant fees. Additionally, REITs have a long history of being associated with the stock market. The investors in these funds have a limited impact on the centralized direction of the funds and the boardroom investment decisions made by the funds.
                <br /> <br />
                <span className="italic">Uncovering Bricklayer’s DAO Token</span>
                <br /> <br />
                No central bank-approved digital asset class can invest into a DAO class, which is why the native (governance) BRICKS token is used. Furthermore, the BRICKS token can allow the DAO to potentially invest in assets currently unable to be funded by fiat currency. The BRICKS are a highly liquid token that appreciates as the DAO treasury inflates in value.
                <br /> <br />
                When evaluating the sustainability of a crypto project, one of the most crucial questions to ask is whether or not the project is accomplishing anything via an append-only log and multiparty consensus that it cannot accomplish through the use of a conventional database structure. Blockchain technology’s trade-offs in terms of performance, privacy, security, and interoperability are something else that must be considered.
                <br /> <br />
                Conversely, the DAO voting mechanism with a majority rule decision-making process is superior in transparency when compared to traditional platforms, plagued with potential conflicts and office politics found in corporate boardrooms and centralized environments.
                <br/> <br />
                We are firm advocates of comprehensive operational transparency, hence we will comply with all applicable KYC/AML laws. This will involve compliance being algorithmically enforced through the use of smart contracts running on one of the blockchain platforms that is currently the most advanced and securely available on the market.
                </p>
                </>
            )
        }
        ...
        content : () => {
            return (
                <p className="text-[20px] mt-4">
                    ...
                    <br /> <br />
                    Instead of dealing with typical real estate interests in an anachronistic way using paper documents, buyers are able to participate in transactions digitally using tokens, rendering the traditional method of dealing with regular real estate interests obsolete.
                    <br/> <br/>
                    <span className="italic">UN-TOKENIZED REAL ESTATE ON A TOKENIZED DAO</span>
                    <br /> <br />
                    Overall, there are three core components of our ecosystem that will be explored further:
                    <br/>
                    <ul>
                        <li>Real Estate</li>
                        <li>Crypto-Pool</li>
                    ...
                    <br/> <br/>
                    The selected real estate asset management AP will oversee the Bricklayer DAO portfolio. Responsibilities will include resolving/negotiating issues with tenants, providing recommendations to the DAO regarding capital asset management issues, reviewing and approving reconciliations and real estate taxes, rent collection, and generally advising on the portfolio’s health. The AP will work closely with the outsourced property management vendor and oversee its performance.
                    <br/> <br/>
                    <span className="italic">CRYPTO POOL</span>
                    <br/> <br/>
                    The designated AP responsible for the management of the crypto-pool will be tasked with the transaction management and diversification of the crypto-pool. In addition, the cryptocurrency pool will be diversified with various cryptocurrency tokens to manage risk exposure.
                    <br /> <br />
                    Eventually, the performance of this crypto-portfolio will fund future real estate acquisition layers, and the AP crypto-pool manager will be responsible for timely crypto-transmissions to maintain the min 51% real estate asset weighting in the DAO treasury.
                    <br /> <br />
                    <span className="italic">REFI OPPORTUNITIES</span>
                    <br /> <br />
                    The solidity of the real estate in the DAO treasury will act as collateral and generate a competitive lending environment for the DAO treasury and BRICKS token holders alike. Then, the Bricklayer members may vote on deploying refinanced proceeds to fund future real estate acquisitions. This will eliminate the need for the Bricklayer treasury to liquidate any cryptocurrency holdings.
                    <br /> <br />
                    Alternatively, the DAO members may vote not to refinance the treasury and use our DeFi partners to create individual member refinancing opportunities, which would also bring additional revenue into the DAO through a share of interest revenue from our DeFi partner.
                </p>
            )
        }
    },
    ...
    },
    {
        ...
        content : () => {
            return (
                <p className="text-[20px] mt-4">
                    Overall, an on-chain visualization of the DAO ownership structure may be obtained using the Bricklayer Tapestry. Land ownership holdings in the Tapestry will indicate the members “staked" BRICKS token allocation, and each holding will have a corresponding pixel count. The following digital assets will be made available for purchase and will be automatically distributed to holders of NFTs:
                    <br /> <br />
                    Famous Landmark Buildings – 500k pixel allocation with OG NFT series.
                    <br /> <br />
                    Broker Office Blocks – 100k pixel allocation with Broker NFT series, complete with broker signage and access to Broker listing portal.
                    <br /> <br />
                    Alternative Tapestry Items – 1k pixel random allocation with Bricklayer NFT series.
                    <br /> <br />
                    <span className="italic">Staking Rewards (TBC following Tokenomics Validation)</span>
                    <br /> <br />
                    Token holders who stake their BRICKS tokens on the Brickworks Tapestry for 12-month cycles will receive a loyalty reward in the form of new BRICKS tokens:
                    <br /><br />
                    <ul>
                    ...
                    <br /> <br />
                    Moving forward, the novel supply of BRICKS given through staking will be acquired internally using a fraction of the DAO’s treasury revenues and transaction selling fees.
                </p>
            )
        }
    },
    {
        ...
        content : () => {
            return (
                <p className="text-[20px] mt-4">
                    Think Where’s Waldo, think No lose Lottery, albeit every rent quarter, our beloved mascot, Bricktop, will make a surprise appearance in 5 different pixel locations on the Brickwork’s Tapestry over 5-days of the scheduled DAO voting period.
                    <br /> <br />
                    Those members who staked BRICKS on the Tapestry in the location of the randomized winning pixel coordinates where Bricktop appears will be eligible to receive 1/5 of the quarterly rental income from the real estate assets in the DAO Treasury. In addition, the prize fund increases as the Bricklayer Real Estate portfolio expands over the lifetime of the DAO.
                    <br /> <br />
                    For example, $1B assets in the treasury at 5% yield represents $12.5M every 3 months, 1/5 is $2.5M, equating to $500K to each of the 5 lucky members.
                    <br /> <br />
                    The Where’s Bricktop protocol depends on a Chainlink oracle, Verifiable Randomness Function (VRF), to guarantee that the random outcome generation happens in a decentralized, fair, and secure way, which can be verified on-chain.
                </p>
            )
        }
    },
        ...
        content : () => {
            return (
                <p className="text-[20px] mt-4">
                    ...
                    <br /> <br />
                    These rights will deal with handling assets in the DAO Treasury, dispositions, lease events, and the selection of new proposals. Blockchain smart contracts will facilitate voting with all results visible and members notified.
                    <br />
                    ...
                    <p className="text-[16px] ml-12">
                      ...
                      <br />
                      <span className="text-[16px] ml-12">c.viii.1. Government-backed gentrification Projects</span>
                    </p>
                    d. Token burning
                    <br />
                    e. DAO treasury management
                    <br />
                    <span className="text-[16px] ml-12">e.i. Risk exposure and diversification management</span>
                </p>
            )
        }
    },
    ...
    },
    {
        ...
        content : () => {
            return (
                <p className="text-[20px] mt-3">
                    Ethereum represents the technological backbone on which Bricklayer DAO is built. Without a doubt, Ethereum is the most developed ecosystem in terms of DAO development and management tools. Overall, Ethereum’s decentralized and proven consensus is sufficient for enterprises to place their faith in the network.
                    <br /> <br />
                    Once live, the smart contract code cannot be amended, not even by its owners. This permits the DAO to operate according to its set rules. Furthermore, smart contracts are able to transmit and receive funds. To administer collective finances without this, a trustworthy intermediary would be required.
                    <br /> <br />
                    Ultimately, the Ethereum community has shown to be more collaborative than competitive, enabling the rapid emergence of best practices and support mechanisms.
                </p>
            )
        }
    },
        ...
        content : () => {
            return (
                <p className="text-[20px] mt-3">
                    ...
                    <br /> <br />
                    These forward-looking statements are applicable only as of the later of the date of publication of the Lite-paper and the latest date that the Website has been updated. Neither Bricklayer DAO nor its representatives nor any other person represents, warrants and/or undertakes that the actual future results, performance or achievements of Bricklayer DAO will be as discussed in those forward-looking statements.
                    <br /> <br />
