        ...
        content : () => {
            return (
                <div className="border-2 border-white h-[362.44px] w-[623.37px] bg-[#E26E5D]"style={{height:"162.44px"}}>
                    ...
                    <span className="fmb" style={{ marginRight: "0.5rem" }}>11</span> {/* Added inline style for right margin */}
                        <span className="font-semibold">Launch Brickworks<br />Staking Program</span>
                    </div>
                </div>
            )
        }
