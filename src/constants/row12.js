        ...
        content : () => {
            return (
                <div className="border-2 border-white h-[362.44px] w-[623.37px] bg-[#E26E5D]"style={{height:"162.44px"}}>
                    ...
                    <span className="fmb" style={{ marginRight: "0.5rem" }}>12</span> {/* Added inline style for right margin */}
                        <span className="font-semibold">Genesis Layer<br />Transaction<br />Completition &<br />
                        Trasnfer to<br />Treasury</span>
                    </div>
                </div>
            )
        }
