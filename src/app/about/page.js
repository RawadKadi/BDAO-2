...
export default function About() {
  ...
  if (activeLang === disclaimersEng){ 
    ...
    setTimeout(() => 
      setActiveLang(disclaimersArabic),
      500);
      setTimeout(() => 
      setIsFadeButtons(false),
      500);
      setTimeout(() => 
      setActiveEl(disclaimersArabic[activeTarget]),
      500);
  }
    ...
    setTimeout(() => 
      ...
      500);
      setTimeout(() => 
      setActiveEl(disclaimersEng[activeTarget]),
      500);
    };
};
            ...
            <div className="bg-texture flex flex-col">
              ...
              <div className="lg:flex gap-12 lg:mx-20 justify-center mt-12">
                    ...
                    <section className={`lg:block hidden ${isFadeButtons ? 'fade' : 'show'}`}>
                      <div className="font-semibold mt-1">
                        ...
                        className="hover:bg-[#E26E5D] opacity-90 border-transparent py-2 w-full block">
                            <div className={activeLang === disclaimersEng ? 'flex gap-5' : 'flex gap-5 justify-end'}>
                              <span className={`mr-4 ${activeLang === disclaimersEng ? '' : 'order-2'}`}>{item.id}</span>
                ...
                <div className="column-2 bg-opacity-80 relative bg-[#E26E5D] border-3 border-white mb-56 lg:block hidden">
                  <section 
                  className={`p-16 ${isFade ? 'fade' : 'show'}`}>
